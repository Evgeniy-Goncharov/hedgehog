...
/*!********************!*\
  !*** ./js/main.js ***!
  \********************/
/*! no exports provided */function(e,t,a){"use strict";a.r(t);var i=a(/*! ./utils/ios-vh-fix */"./js/utils/ios-vh-fix.js"),s=a(/*! ./modules/gallery */"./js/modules/gallery.js"),r=a(/*! ./modules/mobile-menu */"./js/modules/mobile-menu.js");window.addEventListener("DOMContentLoaded",(function(){Object(i.iosVhFix)(),window.addEventListener("load",(function(){Object(s.default)(),Object(r.initMenu)()}))}))},"./js/modules/gallery.js":
/*!*******************************!*\
  !*** ./js/modules/gallery.js ***!
  \*******************************/
/*! exports provided: default */function(e,t,a){"use strict";a.r(t),a.d(t,"default",(function(){return n}));var i=a(/*! ../vendor/swiper */"./js/vendor/swiper.js"),s=a.n(i),r=document.querySelector("[data-slider=gallery]");function n(){if(r)return new s.a(r,{slidesPerView:"auto",spaceBetween:34,breakpoints:{1280:{slidesPerView:2,spaceBetween:39,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}}})}},"./js/modules/mobile-menu.js":
/*!***********************************!*\
  !*** ./js/modules/mobile-menu.js ***!
  \***********************************/
/*! exports provided: initMenu */function(e,t,a){"use strict";a.r(t),a.d(t,"initMenu",(function(){return n}));var i=document.querySelector("[data-menu=mobile-menu-wrapper]"),s=document.querySelector("[data-menu=menu-button]"),r=document.querySelectorAll("[data-menu]"),n=function(){if(i&&s){var e=function(e){"Escape"===e.key&&a()},t=!1;r.forEach((function(e){e.classList.remove("no-js")}));var a=function a(){r.forEach((function(e){e.classList.remove("is-open")})),s.ariaLabel="Открыть меню",s.ariaPressed=!1,t=!1,document.body.classList.remove("scroll-lock"),document.removeEventListener("click",a),document.removeEventListener("keydown",e)};a(),s.addEventListener("click",(function(i){i.stopPropagation(),t?a():(r.forEach((function(e){e.classList.add("is-open")})),s.ariaLabel="Закрыть меню",s.ariaPressed=!0,t=!0,document.body.classList.add("scroll-lock"),document.addEventListener("click",a),document.addEventListener("keydown",e))})),i.addEventListener("click",(function(e){e.target.href||e.stopPropagation()}))}}},"./js/utils/ios-checker.js":
/*!*********************************!*\
